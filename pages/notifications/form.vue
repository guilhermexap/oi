        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex gap-3">
            ...
            >
              ...
              <span v-else>Publicar notificação</span>
            </UButton>
          </div>
        </div>
        <div class="mx-auto mt-4">
          <h5>Dados do notificação</h5>
          <div class="grid grid-cols-2 gap-4">
            <div class="py-4 flex gap-4 flex-col">
              ...
              <UFormGroup label="Tipo de usuário" name="GEN_USER_GROUP_ID">
                <SelectMenu
...
const state = reactive({
  ...
  GEN_USER_GROUP_ID: selectedData.value?.GEN_USER_GROUP_ID as
    | string
    | undefined,
  INITIAL_DATE:
...
onMounted(async () => {
  ...
  if (Array.isArray(responseGroups)) {
    optionsGroups.value = responseGroups.map(({ NAME, ID }) => ({
      label: NAME,
      value: ID,
    }));
  }
