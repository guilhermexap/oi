            ...
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form" @submit.prevent="submitForm">
                  ...
                  <ArgonCheckbox
                    id="terms"
                    v-model:checked="formData.isChecked"
                    name="terms"
                  >
...
const rules = computed(() => {
  return {
    ...
    email: {
      ...
      email: helpers.withMessage("Formato e-mail inválido", email),
    },
    password: {
      required: helpers.withMessage("O campo email é obrigatório.", required),
  ...
  if (v$.value.$error || !formData.isChecked) {
    ...
    if (!formData.isChecked) {
      errorsRef.value = [
        ...
        {
          $property: "terms",
          $message: "Você precisa aceitar nossos termos e condições. ",
        },
      ];
    }
  } else {
