...
<template>
  <UContainer>
          ...
          <div class="grid grid-cols-5 gap-4">
            <div class="py-4 flex gap-4 flex-col col-span-3">
              ...
              <div class="flex w-full gap-3">
                ...
                <!-- <UFormGroup v-if="route.query.ID" name="STATUS_APP">
                  <UCheckbox
                    id="nuxt-checkbox"
            ...
            <div class="flex flex-col p-4 col-span-2">
              ...
              <!-- <div
                class="border-t h-1 overflow-visible mt-4 text-center text-gray-300 py-2"
              >
                <span class="relative -top-6 text-xs bg-white px-1 text-black"
                  >ou</span
                >
              </div> -->
    ...
    <!-- TABELA -->
    <SpaceTable v-if="route.query.ID" :serviceId="serviceId || ''" />
  </UContainer>
</template>
...
async function onSubmit(event: FormSubmitEvent<Schema>) {
  ...
  const data = {
    ...
    // STATUS_APP: services.convertToString(state.STATUS_APP),
