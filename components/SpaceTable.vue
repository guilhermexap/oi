    ...
    >
      <div class="p-4">
        <div class="flex flex-col gap-4">
          ...
          <UFormGroup label="Espaço" name="GEN_STRUCTURE_ID" class="flex-grow">
            <USelect
  ...
  async () => {
    if (props.serviceId !== "") {
      const response = await $fetch(
        `${apiBaseUrl}/services-timesheet-rel?nrorg=${NumberOrg}&service-id=${props.serviceId}&${searchStatus.value}`,
        {
          headers: {
